...
class InvitationTemplatesCVC2: UICollectionViewCell {

    @IBOutlet weak var shahiwalDateWithMonths: UILabel!
    @IBOutlet weak var englishDateWithMonths: UILabel!
    ...
    @IBOutlet weak var englishDatelblWithNumbers: UILabel!
    @IBOutlet weak var shawalDatelblWIthNNumbers: UILabel!
...
extension InvitationTemplatesCVC2 {
    ...
    func configure(with invitation: InvitationModel, userFromViewScreen: Bool) {
        ...
        shawalDatelblWIthNNumbers.text = invitation.islamicDate
